<script lang='ts'>
    ...
    import { animatePopup, playbackRate } from 'lib/storage/items.svelte'
...
<div class={['bg flex flex-col h-[34.375rem] min-w-[31.25rem] w-fit whitespace-nowrap overflow-hidden', animatePopup.value ? 'animate' : '']}>
